package com.manaul.highschool.bottomnavigation;
...
import com.manaul.highschool.bottomnavigation.behaviour.BottomNavBarFabBehaviour;
import com.manaul.highschool.bottomnavigation.behaviour.BottomVerticalScrollBehavior;
import com.manaul.highschool.bottomnavigation.floatingactionbutton.FloatingActionButton;
import com.manaul.highschool.bottomnavigation.utils.Utils;
...
public class BottomNavigationBar extends FrameLayout {
    ...
    public static final int FAB_BEHAVIOUR_TRANSLATE_AND_STICK = 0;
    ...
    ArrayList<BottomNavigationItem> mBottomNavigationItems = new ArrayList<BottomNavigationItem>();
    ArrayList<BottomNavigationTab> mBottomNavigationTabs = new ArrayList<BottomNavigationTab>();
    ...
    private void parseAttrs(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mActiveColor = typedArray.getColor(R.styleable.BottomNavigationBar_bnbActiveColor, Utils.fetchContextColor(context, R.color.colorAccent));
            ...
            mActiveColor = Utils.fetchContextColor(context, R.color.colorAccent);
...
//                && oldPosition != -1) {
    ...
    // scheduled for next
    public void setFab(FloatingActionButton fab, @FabBehaviour int fabBehaviour) {
        ViewGroup.LayoutParams layoutParams = fab.getLayoutParams();
        if (layoutParams != null && layoutParams instanceof CoordinatorLayout.LayoutParams) {
            CoordinatorLayout.LayoutParams coLayoutParams = (CoordinatorLayout.LayoutParams) layoutParams;
            BottomNavBarFabBehaviour bottomNavBarFabBehaviour = new BottomNavBarFabBehaviour();
