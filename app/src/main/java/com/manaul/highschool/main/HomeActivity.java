...
import com.manaul.highschool.bottomnavigation.BadgeItem;
...
import com.manaul.highschool.bottomnavigation.ShapeBadgeItem;

public class HomeActivity extends FragmentActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener, BottomNavigationBar.OnTabSelectedListener {
...
//    FloatingActionButton fabHome;
    ...
    Button toggleHide;       //控制下面的按钮的整个行
    Button toggleBadge;     //控制小圆点
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_github:
                String url = "http://blog.csdn.net/wenzhi20102321";
